...
const ViewFestival = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      {!loading && (
        <>
          <h1 className="text-2xl font-semibold text-red-500 mb-6 text-center">
                ...
                <tbody>
                  {sortedFestivals.length ? (
                    sortedFestivals.map((festival) => (
                      <tr
                        key={festival.id}
                        className={`${festival.status ? "bg-white" : "bg-gray-200"
                          }`}
                      >
                        ...
                        <td className="py-2 px-4 border-b border-gray-200 text-sm text-center">
                          {festival.status ? (
                            ...
                            <span className="text-gray-500">Completed</span> // Placeholder for closed status
                          )}
                        </td>
                      </tr>
                    ))
