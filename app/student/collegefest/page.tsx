...
const CollegeFest = () => {
    ...
    const filteredFestivals = festivals.filter(festival => festival.college.id === collegeId);

    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4 text-black">Collegefest</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredFestivals.map((festival) => (
                    <div key={festival.id} className="border rounded-lg overflow-hidden shadow-lg">
                        <div className="w-full h-80 relative">
                            <Image
                                src={typeof festival.imageUrl === 'string' ? festival.imageUrl : '/defaultImage.jpg'}
