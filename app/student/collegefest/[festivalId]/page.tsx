                    ...
                    <table className="w-full border-collapse text-lg">
                        <tbody>
                            <tr className="border-b">
                                ...
                                <td className="text-base p-4">{festival.festivalTitle}
                                    <Link href={`/student/collegefest/view-events/${festival.id}`} legacyBehavior><a className="text-blue-500">(View Events)</a></Link>
                                </td>
                            </tr>
                            <tr className="border-b">
                            ...
                            <tr className="border-b">
                                ...
                                <td className="text-base p-4">{festival.status ? 'Active' : 'Inactive'}</td>
                            </tr>
                        </tbody>
                    </table>
